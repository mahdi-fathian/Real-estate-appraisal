...
سامانه سیماب در راستای مکانیزه کردن ارزیابی املاک و ساختمان‌های بانک مسکن، وثایق ملکی تسهیلات اعطایی به مشتریان بانک و همچنین امکان ارائه اطلاعات ارزیابی بین سرویس‌های مختلف بانک را فراهم می‌سازد.
...
این پروژه برای استفاده داخلی در بانک مسکن طراحی شده است.
